...
<tr>
	...
	<c:if test="${requestScope.list != null }">
		...
		<c:set var="address" value="${zipcodeDTO.sido} ${zipcodeDTO.sigungu} ${zipcodeDTO.yubmyundong} ${zipcodeDTO.ri} ${zipcodeDTO.roadname} ${zipcodeDTO.buildingname } "></c:set>
										<!-- 만약 위엣줄을 엔터로 줄바꿈을 해버리면 이 문장은 에러가 발생되지 않고아무동작을 하지 않음 -->
		<tr>
