function checkWrite(){
         ...
         //if(id 속성을 지정해서 name의 값이 있는지 없는지 검사   )
         //else if(id 속성을 지정해서 name의 값이 있는지 없는 지 검사)
         ...
         if(document.getElementById("name").value== "")  //alert("이름을 입력하세요");
            ...
            document.getElementById("idDiv").innerText = "아이디 입력하세요";
...
function checkId(){
   ...
   if(id =="")
	  ...
	  window.open("/mvcmember/member/checkId.do?id=" + id, 'idcheck',"width = 450 height = 100");
